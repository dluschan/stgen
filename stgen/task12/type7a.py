...
class Type7b(Task12):
    ...
    def category(self):
        return Task12.category(self) + 'Тип 7a'
    ...
    def question_text(self):
        ...
        return Task12.question_text(self) + question.format(**{'host': self.latex(self.task.host()), 'network': self.latex(self.task.network()), 'number': self.number})
